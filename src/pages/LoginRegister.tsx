...
const TabsDemo: React.FC = () => {
    ...
    const [registerData, setRegisterData] = useState<RegisterData>({ email: "", password: "", confirmPassword: "" });
    const [submittedData, setSubmittedData] = useState<(LoginData | RegisterData)[]>([]);
    ...
    const handleRegisterSubmit = (e: FormEvent<HTMLFormElement>) => {
        ...
        setSubmittedData((prev) => [...prev, { type: "register", ...registerData }]);
    ...
    return (
        <div className="flex items-center justify-center min-h-screen bg-gray-50 p-4">
            <Tabs.Root
                className="flex w-full max-w-md md:max-w-4xl md:h-[500px] flex-col rounded-lg shadow-lg bg-white p-6 md:p-8"
            ...
            >
                <Tabs.List className="flex border-b mb-4">
                    <Tabs.Trigger
                        className={`flex-1 py-3 text-center cursor-pointer text-lg font-semibold ${activeTab === "tab1" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-600"
                            }`}
                        value="tab1"
                    >
                        Se connecter
                    ...
                    <Tabs.Trigger
                        className={`flex-1 py-3 text-center cursor-pointer text-lg font-semibold ${activeTab === "tab2" ? "text-blue-600 border-b-2 border-blue-600" : "text-gray-600"
                            }`}
                        value="tab2"
                    >
                        S'enregistrer
                ...
                <div className="flex flex-col md:flex-row justify-between">
                    <div className="w-full md:w-1/2 pr-0 md:pr-8">
                        <Tabs.Content value="tab1">
                            <h2 className="text-2xl font-bold mb-4 text-center">Bienvenue sur Muzak !</h2>
                            <form onSubmit={handleLoginSubmit} className="space-y-4">
                                <div className="relative">
                                    <label className="block text-gray-600 mb-1" htmlFor="loginEmail">
                                        Email
                                    </label>
                                    <input
                                        id="loginEmail"
                                ...
                                <div className="relative">
                                    <label className="block text-gray-600 mb-1" htmlFor="loginPassword">
                                        Mot de passe
                                    </label>
                                    <input
                                        id="loginPassword"
                        ...
                        <Tabs.Content value="tab2">
                            <h2 className="text-2xl font-bold mb-4 text-center">Crée ton compte Muzak !</h2>
                            <form onSubmit={handleRegisterSubmit} className="space-y-4">
                                <div className="relative">
                                    <label className="block text-gray-600 mb-1" htmlFor="registerEmail">
                                        Email
                                    </label>
                                    <input
                                        id="registerEmail"
                                ...
                                <div className="relative">
                                    <label className="block text-gray-600 mb-1" htmlFor="registerPassword">
                                        Mot de passe
                                    </label>
                                    <input
                                        id="registerPassword"
